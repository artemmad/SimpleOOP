...
public class Rect {
    public double getWidth() {
        ...
        System.out.println("Ширина по точкам и по значению не сходится. Выкиньте компьютер");
        return 0;
    }
    ...
    public double getHeight() {
        ...
        System.out.println("Длина по точкам и по значению не сходится. Выкиньте компьютер");
        return 0;
    }
